...
const HeroSection = () => (
  <section className="w-full bg-white dark:bg-neutral-950 text-black dark:text-white flex flex-col items-center relative py-16 px-4 transition-colors">
    <div className="max-w-5xl w-full flex flex-col md:flex-row items-center gap-10">
      ...
      <div className="flex-1 space-y-5">
        ...
        <p className="max-w-xl text-base text-gray-700 dark:text-gray-200 leading-relaxed">
