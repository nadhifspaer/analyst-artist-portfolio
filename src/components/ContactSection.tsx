...
const handleSubmit = (e: React.FormEvent) => {
  ...
  // Compose email body
  const mailto = `mailto:nadhifspaer01@gmail.com?subject=Contact from Portfolio&body=Email: ${email}%0AName: ${name}%0A${encodeURIComponent(
    message as string,
  )}`;
  ...
  <section className="w-full bg-neutral-900 dark:bg-black text-white py-20 px-4 flex flex-col items-center">
    ...
    <div className="mt-10 flex flex-col gap-3 items-center">
      <div className="flex items-center gap-2">
        ...
        <span className="text-white font-medium">@nadhifspaer</span>
      </div>
      <div className="flex items-center gap-2">
        {whatsappSVG}
        <span className="text-white font-medium">08111119363</span>
      </div>
      <div className="flex items-center gap-2">
