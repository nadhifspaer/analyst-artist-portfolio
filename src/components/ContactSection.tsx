...
const ContactSection = () => {
  ...
  return (
    <section className="w-full bg-neutral-900 dark:bg-black text-white py-20 px-4 flex flex-col items-center">
      ...
      {/* Social section (as a row, all icons clickable except WhatsApp, as specified) */}
      <div className="mt-10 flex flex-row gap-6 items-center justify-center">
        {/* Instagram - clickable, no username */}
        <a
        ...
        {/* WhatsApp - just text */}
        <span className="text-white font-medium text-base px-3">{whatsappSVG} <span className="ml-1">08111119363</span></span>
        {/* LinkedIn - clickable, no username */}
        <a
