...
const ContactSection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Submitting contact form:", { name, email, messageLength: message.length });
  ...
  return (
    <section className="w-full bg-neutral-900 dark:bg-black text-white py-20 px-4 flex flex-col items-center">
      ...
      <div className="mt-10 flex flex-row gap-6 items-center justify-center">
        ...
        <span className="text-white font-medium text-base px-3 flex items-center">
          {whatsappSVG}<span className="ml-1">08111119363</span>
        </span>
        <a
