...
const ProjectsSection = () => {
  ...
  return <section id="projects-section" className="w-full bg-white dark:bg-neutral-950 py-20 px-4 flex flex-col items-center relative z-10">
      <div className="max-w-3xl w-full flex flex-col">
        ...
        <div className="flex flex-col gap-8">
          {projects.map(project => <div key={project.id} className="flex flex-col md:flex-row items-center bg-neutral-100 dark:bg-neutral-900 p-6 rounded-xl shadow transition">
              ...
              <div className="flex-1">
                ...
                <button className={`flex items-center gap-2 px-6 py-2 rounded-md font-semibold mt-1 shadow transition ${project.btn.color}`} onClick={() => navigate(`/projects/${project.id}`)}>
